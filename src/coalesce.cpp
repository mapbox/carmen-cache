...
void coalesceFinalize(std::vector<Context>& features, std::vector<Context> const& contexts) {
    if (contexts.size() > 0) {
...
void Cache::coalesceSingle(std::vector<PhrasematchSubq> const& stack, std::vector<unsigned> const& centerzxy, std::vector<unsigned> const& bboxzxy, std::vector<Context>& features) {
    ...
    coalesceFinalize(features, contexts);
}

void Cache::coalesceMulti(std::vector<PhrasematchSubq> const& stack, std::vector<unsigned> const& centerzxy, std::vector<unsigned> const& bboxzxy, std::vector<Context>& features) {
